...
#define C1 Controller1.Axis1.position(degrees)
#define C2 Controller1.Axis2.position(degrees)
#define C3 Controller1.Axis3.position(degrees)
#define C4 Controller1.Axis4.position()

...
motor ChLF = motor(PORT12, ratio6_1, false);//地盘
motor ChLB = motor(PORT20, ratio6_1, false);
motor ChRF = motor(PORT19, ratio6_1,true);
motor ChRB = motor(PORT11, ratio6_1,true);
